...
args.data_dir='/home/auto-114/PycharmProjects/neon_study_04/data'
train_idx, val_idx, all_idx, test_idx, noise_idx = create_index_files(args.data_dir)

train_dir = os.path.join(args.data_dir, 'train')
common_params = dict(sampling_freq=2000, clip_duration=2000, frame_duration=128, overlap_percent=50)
